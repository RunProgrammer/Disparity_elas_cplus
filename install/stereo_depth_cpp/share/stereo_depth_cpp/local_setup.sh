...
: ${AMENT_CURRENT_PREFIX:="/mnt/hs2/SLAM-nav2/ros2_ws_stereo/install/stereo_depth_cpp"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/stereo_depth_cpp/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/stereo_depth_cpp/environment/path.sh"
